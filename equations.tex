...
\end{table}
\vspace*{-.5cm}    
{\centering\input{kinetics/0/0a/mygraph.tex}\\[-3.5ex]
\input{kinetics/0/0b/mygraph.tex}\\[-3.5ex]
...
\begin{center}
          \begin{tabular}{ccSl}
               ...
               \ce{RC(O)CH3}  &   \ce{RC(O)CH2}$^{-}$ & 20                       &   \textalpha\ H of ketones\\
...
\includepdf[pages=1-3]{stats.pdf}
}
