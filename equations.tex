...
\begin{equation*}
\mu = \sqrt{\frac{3RT}{\mathcal{M}}}
\end{equation*}

Rates of Effusion by Molar Mass
\begin{equation*}
\frac{\textnormal{rate}_1}{\textnormal{rate}_2} = \sqrt{\frac{\mathcal{M}_2}{\mathcal{M}_1}}
\end{equation*}
...
\begin{center}
          \begin{tabular}{ccSll}
               ...
               \midrule
               HI             &   I$^{-}$          &  -10                        &   hydroiodic acid & \rdelim\}{6}{1mm}[strong acids] \\
               ...
               \midrule
               \ce{HSO4}$^{-}$ & \ce{SO4}$^{2-}$   &   2                         &   2\textsuperscript{nd} H of sulfuric acid & \rdelim\}{21}{1mm}[weak acids] \\
               ...
               \ce{RC#CH}     &   \ce{RC#C}$^{-}$  &   25                        &   terminal alkyne (\textit{sp} C---H) & \\
               \ce{H2}        &   H$^{-}$          &   36                        &   hydrogen gas & \\
               \ce{NH3}       &   \ce{NH2}$^{-}$   &   38                        &   ammonia & \\
               \ce{RNH2}      &   RNH$^{-}$        &   40                        &   aliphatic amines & \\ 
               \ce{PhCH3}     &   \ce{PhCH2}$^{-}$ &   41                        &   benzylic ($sp^3$ C---H) & \\
               \ce{C6H6}      &    \ce{C6H5}$^{-}$ &   42                        &   aryl ($sp^2$ C---H) & \\
               \ce{H2C=CHCH3} &   \ce{H2C=CHCH2}$^{-}$ &  43                     &   allylic ($sp^3$ C---H) & \\
               \ce{RCH=CH2}   &   \ce{RCH=CH}$^{-}$ &  47                        &   vinylic ($sp^2$ C---H) & \\
               \ce{RCH3}       &   \ce{RCH2}$^{-}$   &   50                     &   alkanes ($sp^3$ C---H) & \\ 
               \bottomrule
          \end{tabular}
\end{center}
