...
\usepackage{microtype,graphicx,float,booktabs,verbatim,siunitx,mathrsfs,titlesec,parskip,fullpage,nicefrac}
...
\begin{equation*}
\textnormal{\Enotcell} = \textnormal{$\mathscr{E}^{\circ}_{\textnormal{ox}}$} - \textnormal{$\mathscr{E}^{\circ}_{\textnormal{red}}$}  = \frac{RT}{nF} \ln K
\end{equation*}
