...
\usepackage{microtype,graphicx,booktabs,siunitx,titlesec,parskip,fullpage,nicefrac,float,multirow,bigdelim}
%\usepackage[artemisia]{textgreek}
\usepackage{mlmodern,upgreek}
...
\usepackage[font=normalsize,labelfont=bf]{caption}\captionsetup[table]{aboveskip=2pt}
